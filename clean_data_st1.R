...
base::save(int_consist_traits_st1, file = "data/int_consist_traits_st1.rda") # save for later import
...
base::save(int_consist_facets_st1, file = "data/int_consist_facets_st1.rda") # save for later import
