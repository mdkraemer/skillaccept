...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with extraversion change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_curr_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with extraversion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_ideal_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with extraversion change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_curr_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with extraversion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with agreeableness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_agree_curr_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with agreeableness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_agree_ideal_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with agreeableness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_agree_curr_specif_hyp4 %>% filter(term=="goals ~~ d_agree_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_specif_hyp4 %>% filter(term=="goals ~~ d_agree_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with conscientiousness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_curr_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with conscientiousness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_ideal_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with conscientiousness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_curr_specif_hyp4 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_specif_hyp4 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with neuroticism change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_neuro_curr_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with neuroticism change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_neuro_ideal_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with neuroticism change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_neuro_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with openness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_curr_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with openness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_ideal_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with openness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_curr_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with openness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with sociability change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_socia_curr_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with sociability change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_socia_ideal_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with anxiety change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_socia_ideal_specif_hyp4 %>% filter(term=="d_socia_1 ~~ sb07_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_specif_hyp4 %>% filter(term=="d_socia_1 ~~ sb07_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with assertiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_curr_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with assertiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_ideal_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with assertiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_curr_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with assertiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_ideal_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with energy change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_energ_curr_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with energy change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_energ_ideal_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with energy change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_energ_ideal_specif_hyp4 %>% filter(term=="d_energ_1 ~~ sb07_03_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_specif_hyp4 %>% filter(term=="d_energ_1 ~~ sb07_03_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with compassion change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_compa_curr_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with compassion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_compa_ideal_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with respectfulness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_curr_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with respectfulness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_ideal_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with respectfulness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_curr_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the respectfulness change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_respe_ideal_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with trust change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_curr_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with trust change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_ideal_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with trust change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_ideal_specif_hyp4 %>% filter(term=="d_trust_1 ~~ sb07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_specif_hyp4 %>% filter(term=="d_trust_1 ~~ sb07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with organization change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_organ_curr_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with organization change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_organ_ideal_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with organization change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_organ_curr_specif_hyp4 %>% filter(term=="d_organ_1 ~~ sb07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_specif_hyp4 %>% filter(term=="d_organ_1 ~~ sb07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with productiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_curr_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with productiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_ideal_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with productiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_curr_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with productiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_ideal_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with responsibility change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respo_curr_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with responsibility change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_respo_ideal_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with responsibility change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respo_curr_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with responsibility change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_respo_ideal_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with anxiety change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_anxie_curr_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with anxiety change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_anxie_ideal_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the anxiety change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_anxie_curr_specif_hyp4 %>% filter(term=="d_anxie_1 ~~ sb07_10_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_specif_hyp4 %>% filter(term=="d_anxie_1 ~~ sb07_10_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with depression change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_depre_curr_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with depression change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_depre_ideal_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with depression change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_depre_curr_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the depression change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_depre_ideal_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with volatility change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_volat_curr_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with volatility change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_volat_ideal_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_ideal_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with volatility change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_volat_curr_specif_hyp4 %>% filter(term=="d_volat_1 ~~ sb07_12_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_specif_hyp4 %>% filter(term=="d_volat_1 ~~ sb07_12_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with curiosity change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_curio_curr_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with curiosity change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_curio_ideal_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_ideal_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with aesthetic change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_aesth_curr_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with aesthetic change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_aesth_ideal_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_ideal_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with imagination change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_imagi_curr_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with imagination change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_imagi_ideal_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of general acceptance goal with the extraversion change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_extra_curr_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with extraversion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_ideal_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with extraversion change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_curr_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with extraversion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_extra_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with agreeableness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_agree_curr_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with agreeableness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_agree_ideal_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with agreeableness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_agree_curr_specif_hyp5 %>% filter(term=="goals ~~ d_agree_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_specif_hyp5 %>% filter(term=="goals ~~ d_agree_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with conscientiousness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_curr_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with conscientiousness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_ideal_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with conscientiousness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_curr_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the conscientiousness change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_consc_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with neuroticism change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_neuro_curr_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with neuroticism change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_neuro_ideal_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with neuroticism change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_neuro_curr_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the neuroticism change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_neuro_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with openness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_curr_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of the general acceptance goal with the openness change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_openn_ideal_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. (I had to use the 'WLSMV' estimator with the "ordered" argument here to get the model to converge - not sure if this is comparable to the other models since a really small estimate becomes significant here...)
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with openness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_curr_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the openness change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_openn_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. (I had to use the 'WLSMV' estimator with the "ordered" argument here to get the model to converge - not sure if this is comparable to the other models since a really small estimate becomes significant here...)
:::
...
::: {.callout-note appearance="minimal"}
The correlation of the general acceptance goal with the sociability change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_socia_curr_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with sociability change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_socia_ideal_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with anxiety change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_socia_ideal_specif_hyp5 %>% filter(term=="d_socia_1 ~~ sa07_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_specif_hyp5 %>% filter(term=="d_socia_1 ~~ sa07_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with assertiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_curr_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with assertiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_ideal_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with assertiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_asser_curr_specif_hyp5 %>% filter(term=="d_asser_1 ~~ sa07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_specif_hyp5 %>% filter(term=="d_asser_1 ~~ sa07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with energy change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_energ_curr_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with energy change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_energ_ideal_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with compassion change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_compa_curr_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with compassion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_compa_ideal_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with compassion change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_compa_curr_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with compassion change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_compa_ideal_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with respectfulness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_curr_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with respectfulness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_ideal_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with respectfulness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_curr_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with respectfulness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_respe_ideal_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with trust change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_curr_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with trust change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_ideal_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with trust change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_curr_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with trust change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_trust_ideal_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with organization change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_organ_curr_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with organization change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_organ_ideal_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the organization change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_organ_curr_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with organization change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_organ_ideal_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with productiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_curr_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with productiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_ideal_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with productiveness change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_curr_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with productiveness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_produ_ideal_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with responsibility change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_respo_curr_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with responsibility change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_respo_ideal_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with anxiety change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_anxie_curr_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with anxiety change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_anxie_ideal_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with anxiety change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_anxie_ideal_specif_hyp5 %>% filter(term=="d_anxie_1 ~~ sa07_10_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_specif_hyp5 %>% filter(term=="d_anxie_1 ~~ sa07_10_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with depression change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_depre_curr_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with depression change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_depre_ideal_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with volatility change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_volat_curr_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of general acceptance goal with the volatility change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_volat_ideal_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_ideal_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with curiosity change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_curio_curr_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with curiosity change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_curio_ideal_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_ideal_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the curiosity change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_curio_curr_specif_hyp5 %>% filter(term=="d_curio_1 ~~ sa07_13_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_specif_hyp5 %>% filter(term=="d_curio_1 ~~ sa07_13_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with aesthetic change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_aesth_curr_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with aesthetic change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_aesth_ideal_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_ideal_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with imagination change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_imagi_curr_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with imagination change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_imagi_ideal_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with imagination change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_imagi_curr_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with imagination change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_imagi_ideal_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Looking at the facets, we find five covariances that significantly differ from zero (relatively unsystematic across facets / current-ideal / goal dimension):  
...
- Lastly, for ideal-level personality, only changes in volatility covary with the general acceptance goal.  
:::
...
::: {.callout-note appearance="minimal"}
The frequency of skill-building behaviors significantly moderates changes in conscientiousness (current-self), *b* = `r round(params_lcs_consc_curr_frequ_hyp6 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_frequ_hyp6 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(p.value), 3)`, although in an unexpected direction such that more frequent skill-building behaviors are associated with more pronounced *decreases* in conscientiousness. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of skill-building behaviors significantly moderates changes in trust (current-self), *b* = `r round(params_lcs_trust_curr_frequ_hyp6 %>% filter(term=="d_trust_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_frequ_hyp6 %>% filter(term=="d_trust_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of skill-building behaviors significantly moderates changes in organization (current-self), *b* = `r round(params_lcs_organ_curr_frequ_hyp6 %>% filter(term=="d_organ_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_frequ_hyp6 %>% filter(term=="d_organ_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
### Hypothesis 7: Desire to change and frequency of self-acceptance behaviors as moderators of change in personality in self-acceptance group {#hyp7}
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in extraversion (ideal-self), *b* = `r round(params_lcs_extra_ideal_frequ_hyp7 %>% filter(term=="d_extra_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_frequ_hyp7 %>% filter(term=="d_extra_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in agreeableness (ideal-self), *b* = `r round(params_lcs_agree_ideal_frequ_hyp7 %>% filter(term=="d_agree_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_frequ_hyp7 %>% filter(term=="d_agree_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in conscientiousness (ideal-self), *b* = `r round(params_lcs_consc_ideal_frequ_hyp7 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_frequ_hyp7 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(p.value), 3)`, although in an unexpected direction such that more frequent self-acceptance behaviors are associated with more pronounced *decreases* in conscientiousness. 
:::
...
::: {.callout-note appearance="minimal"}
Trait-/facet-level specific acceptance goals significantly moderate changes in neuroticism (ideal-self), *b* = `r round(params_lcs_neuro_ideal_specif_hyp7 %>% filter(term=="d_neuro_1 ~ goals") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_specif_hyp7 %>% filter(term=="d_neuro_1 ~ goals") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of specific, facet-level acceptance goals with the openness change score (ideal-self) is not significantly different from zero, *b* = `r round(params_lcs_openn_ideal_specif_hyp7 %>% filter(term=="d_openn_1 ~ goals") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_specif_hyp7 %>% filter(term=="d_openn_1 ~ goals") %>% pull(p.value), 3)`. (... model did not converge properly!)
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of frequency of self-acceptance behaviors with the openness change score (ideal-self) is not significantly different from zero, *b* = `r round(params_lcs_openn_ideal_frequ_hyp7 %>% filter(term=="d_openn_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_frequ_hyp7 %>% filter(term=="d_openn_1 ~ frequ") %>% pull(p.value), 3)`. (... model did not converge properly!)
:::
...
swls_t1 =~ 1*sw06_01_t1 + c("lamb2a", "lamb2b")*sw06_02_t1 + c("lamb3a", "lamb3b")*sw06_03_t1 + c("lamb4a", "lamb4b")*sw06_04_t1 + c("lamb5a", "lamb5b")*sw06_05_t1 # This specifies the measurement model for swls_t1 
swls_t2 =~ 1*sw06_01_t2 + c("lamb2a", "lamb2b")*sw06_02_t2 + c("lamb3a", "lamb3b")*sw06_03_t2 + c("lamb4a", "lamb4b")*sw06_04_t2 + c("lamb5a", "lamb5b")*sw06_05_t2 # This specifies the measurement model for swls_t2 with the equality constrained factor loadings
...
sw06_05_t1 ~~ c("cov5a", "cov5b")*sw06_05_t2   # This allows residual covariance on indicator X5 across T1 and T2
...
sw06_05_t1 ~~ c("res5a", "res5b")*sw06_05_t1   # This allows residual variance on indicator X5 at T1
...
sw06_05_t2 ~~ c("res5a", "res5b")*sw06_05_t2  # This allows residual variance on indicator X5 at T2
...
sw06_05_t1 ~ c("m5a", "m5b")*1     # This estimates the intercept of X5 at T1
...
sw06_05_t2 ~ c("m5a", "m5b")*1     # This estimates the intercept of X5 at T2
'
lcs_swls_group_config <- sem(mi_lcs_swls_group_config, data=df_sbsa_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                             group = "rando")

# weak invariance
mi_lcs_swls_group_weak <- '
swls_t1 =~ 1*sw06_01_t1 + c("lamb2", "lamb2")*sw06_02_t1 + c("lamb3", "lamb3")*sw06_03_t1 + c("lamb4", "lamb4")*sw06_04_t1 + c("lamb5", "lamb5")*sw06_05_t1 # This specifies the measurement model for swls_t1 
swls_t2 =~ 1*sw06_01_t2 + c("lamb2", "lamb2")*sw06_02_t2 + c("lamb3", "lamb3")*sw06_03_t2 + c("lamb4", "lamb4")*sw06_04_t2 + c("lamb5", "lamb5")*sw06_05_t2 # This specifies the measurement model for swls_t2 with the equality constrained factor loadings
...
sw06_05_t1 ~ c("m5", "m5")*1     # This estimates the intercept of X5 at T1
...
sw06_05_t2 ~ c("m5", "m5")*1     # This estimates the intercept of X5 at T2
'
...
# -> key parameter is "d_swls_1 ~1" or as labelled parameter "d_int_a" & "d_int_b" (a = Self-Acceptance group, b = Skill-Building group)
kable(broom::tidy(lcs_swls_group_weak, conf.int = FALSE, conf.level = 0.95) %>% 
...
kable(broom::tidy(lcs_swls_group_strong, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_swls_1 ~1 ")), digits = 3) 
```

::: {.callout-note appearance="minimal"}
Slightly more positive change in life satisfaction the Self-Acceptance group but no substantial differences according to the LRTs.
:::
