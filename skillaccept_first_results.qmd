...
params_lcs_swls_hyp2 <- broom::tidy(fit_mi_lcs_swls_hyp2, conf.int = FALSE, conf.level = 0.95) %>% 
...
# parameters of interest
params_lcs_meaning_hyp2 <- broom::tidy(fit_mi_lcs_meaning_hyp2, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
...
# parameters of interest
params_lcs_selfes_hyp2 <- broom::tidy(fit_mi_lcs_selfes_hyp2, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
...
# parameters of interest
params_lcs_concept_hyp2 <- broom::tidy(fit_mi_lcs_concept_hyp2, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
...
Results summary (*sb07_xx_t1* = trait/facet specific acceptance goal):
```{r}
#| echo: true
#| fig-width: 9.5
#| fig-height: 6.5
...
# labelled parameter as "d_int_a" & "d_int_b" (a = Self-Acceptance group, b = Skill-Building group)
kable(broom::tidy(lcs_meaning_group_weak, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_meaning_1 ~1 ")), digits = 3) 

# constrained to be equal in the strong measurement invariance model:
kable(broom::tidy(lcs_meaning_group_strong, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_meaning_1 ~1 ")), digits = 3) 
```
...
# labelled parameter as "d_int_a" & "d_int_b" (a = Self-Acceptance group, b = Skill-Building group)
kable(broom::tidy(lcs_selfes_group_weak, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_selfes_1 ~1 ")), digits = 3) 

# constrained to be equal in the strong measurement invariance model:
kable(broom::tidy(lcs_selfes_group_strong, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_selfes_1 ~1 ")), digits = 3) 
```
...
# labelled parameter as "d_int_a" & "d_int_b" (a = Self-Acceptance group, b = Skill-Building group)
kable(broom::tidy(lcs_concept_group_weak, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_concept_1 ~1 ")), digits = 3) 

# constrained to be equal in the strong measurement invariance model:
kable(broom::tidy(lcs_concept_group_strong, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, label, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("d_concept_1 ~1 ")), digits = 3) 
```
...
# parameters of interest
params_lcs_extra_curr_ppd <- broom::tidy(fit_mi_lcs_extra_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("extra_t2 ~ extra_t1", "d_extra_1 =~ extra_t2", "d_extra_1 ~ extra_t1", # change parameters
...
# parameters of interest
params_lcs_agree_curr_ppd <- broom::tidy(fit_mi_lcs_agree_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("agree_t2 ~ agree_t1", "d_agree_1 =~ agree_t2", "d_agree_1 ~ agree_t1", # change parameters
...
# parameters of interest
params_lcs_consc_curr_ppd <- broom::tidy(fit_mi_lcs_consc_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("consc_t2 ~ consc_t1", "d_consc_1 =~ consc_t2", "d_consc_1 ~ consc_t1", # change parameters
...
# parameters of interest
params_lcs_neuro_curr_ppd <- broom::tidy(fit_mi_lcs_neuro_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("neuro_t2 ~ neuro_t1", "d_neuro_1 =~ neuro_t2", "d_neuro_1 ~ neuro_t1", # change parameters
...
# parameters of interest
params_lcs_openn_curr_ppd <- broom::tidy(fit_mi_lcs_openn_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("openn_t2 ~ openn_t1", "d_openn_1 =~ openn_t2", "d_openn_1 ~ openn_t1", # change parameters
...
# parameters of interest
params_lcs_socia_curr_ppd <- broom::tidy(fit_mi_lcs_socia_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("socia_t2 ~ socia_t1", "d_socia_1 =~ socia_t2", "d_socia_1 ~ socia_t1", # change parameters
...
# parameters of interest
params_lcs_asser_curr_ppd <- broom::tidy(fit_mi_lcs_asser_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("asser_t2 ~ asser_t1", "d_asser_1 =~ asser_t2", "d_asser_1 ~ asser_t1", # change parameters
...
# parameters of interest
params_lcs_energ_curr_ppd <- broom::tidy(fit_mi_lcs_energ_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("energ_t2 ~ energ_t1", "d_energ_1 =~ energ_t2", "d_energ_1 ~ energ_t1", # change parameters
...
# parameters of interest
params_lcs_compa_curr_ppd <- broom::tidy(fit_mi_lcs_compa_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("compa_t2 ~ compa_t1", "d_compa_1 =~ compa_t2", "d_compa_1 ~ compa_t1", # change parameters
...
# parameters of interest
params_lcs_respe_curr_ppd <- broom::tidy(fit_mi_lcs_respe_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("respe_t2 ~ respe_t1", "d_respe_1 =~ respe_t2", "d_respe_1 ~ respe_t1", # change parameters
...
# parameters of interest
params_lcs_trust_curr_ppd <- broom::tidy(fit_mi_lcs_trust_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("trust_t2 ~ trust_t1", "d_trust_1 =~ trust_t2", "d_trust_1 ~ trust_t1", # change parameters
...
# parameters of interest
params_lcs_organ_curr_ppd <- broom::tidy(fit_mi_lcs_organ_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("organ_t2 ~ organ_t1", "d_organ_1 =~ organ_t2", "d_organ_1 ~ organ_t1", # change parameters
...
# parameters of interest
params_lcs_produ_curr_ppd <- broom::tidy(fit_mi_lcs_produ_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("produ_t2 ~ produ_t1", "d_produ_1 =~ produ_t2", "d_produ_1 ~ produ_t1", # change parameters
...
# parameters of interest
params_lcs_respo_curr_ppd <- broom::tidy(fit_mi_lcs_respo_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("respo_t2 ~ respo_t1", "d_respo_1 =~ respo_t2", "d_respo_1 ~ respo_t1", # change parameters
...
# parameters of interest
params_lcs_anxie_curr_ppd <- broom::tidy(fit_mi_lcs_anxie_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("anxie_t2 ~ anxie_t1", "d_anxie_1 =~ anxie_t2", "d_anxie_1 ~ anxie_t1", # change parameters
...
# parameters of interest
params_lcs_depre_curr_ppd <- broom::tidy(fit_mi_lcs_depre_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("depre_t2 ~ depre_t1", "d_depre_1 =~ depre_t2", "d_depre_1 ~ depre_t1", # change parameters
...
# parameters of interest
params_lcs_volat_curr_ppd <- broom::tidy(fit_mi_lcs_volat_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("volat_t2 ~ volat_t1", "d_volat_1 =~ volat_t2", "d_volat_1 ~ volat_t1", # change parameters
...
# parameters of interest
params_lcs_curio_curr_ppd <- broom::tidy(fit_mi_lcs_curio_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("curio_t2 ~ curio_t1", "d_curio_1 =~ curio_t2", "d_curio_1 ~ curio_t1", # change parameters
...
# parameters of interest
params_lcs_aesth_curr_ppd <- broom::tidy(fit_mi_lcs_aesth_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("aesth_t2 ~ aesth_t1", "d_aesth_1 =~ aesth_t2", "d_aesth_1 ~ aesth_t1", # change parameters
...
# parameters of interest
params_lcs_imagi_curr_ppd <- broom::tidy(fit_mi_lcs_imagi_curr_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("imagi_t2 ~ imagi_t1", "d_imagi_1 =~ imagi_t2", "d_imagi_1 ~ imagi_t1", # change parameters
...
# parameters of interest
params_lcs_extra_ideal_ppd <- broom::tidy(fit_mi_lcs_extra_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("extra_t2 ~ extra_t1", "d_extra_1 =~ extra_t2", "d_extra_1 ~ extra_t1", # change parameters
...
# parameters of interest
params_lcs_agree_ideal_ppd <- broom::tidy(fit_mi_lcs_agree_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("agree_t2 ~ agree_t1", "d_agree_1 =~ agree_t2", "d_agree_1 ~ agree_t1", # change parameters
...
# parameters of interest
params_lcs_consc_ideal_ppd <- broom::tidy(fit_mi_lcs_consc_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("consc_t2 ~ consc_t1", "d_consc_1 =~ consc_t2", "d_consc_1 ~ consc_t1", # change parameters
...
# parameters of interest
params_lcs_neuro_ideal_ppd <- broom::tidy(fit_mi_lcs_neuro_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("neuro_t2 ~ neuro_t1", "d_neuro_1 =~ neuro_t2", "d_neuro_1 ~ neuro_t1", # change parameters
...
# parameters of interest
params_lcs_openn_ideal_ppd <- broom::tidy(fit_mi_lcs_openn_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("openn_t2 ~ openn_t1", "d_openn_1 =~ openn_t2", "d_openn_1 ~ openn_t1", # change parameters
...
# parameters of interest
params_lcs_socia_ideal_ppd <- broom::tidy(fit_mi_lcs_socia_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("socia_t2 ~ socia_t1", "d_socia_1 =~ socia_t2", "d_socia_1 ~ socia_t1", # change parameters
...
# parameters of interest
params_lcs_asser_ideal_ppd <- broom::tidy(fit_mi_lcs_asser_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("asser_t2 ~ asser_t1", "d_asser_1 =~ asser_t2", "d_asser_1 ~ asser_t1", # change parameters
...
# parameters of interest
params_lcs_energ_ideal_ppd <- broom::tidy(fit_mi_lcs_energ_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("energ_t2 ~ energ_t1", "d_energ_1 =~ energ_t2", "d_energ_1 ~ energ_t1", # change parameters
...
# parameters of interest
params_lcs_compa_ideal_ppd <- broom::tidy(fit_mi_lcs_compa_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("compa_t2 ~ compa_t1", "d_compa_1 =~ compa_t2", "d_compa_1 ~ compa_t1", # change parameters
...
# parameters of interest
params_lcs_respe_ideal_ppd <- broom::tidy(fit_mi_lcs_respe_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("respe_t2 ~ respe_t1", "d_respe_1 =~ respe_t2", "d_respe_1 ~ respe_t1", # change parameters
...
# parameters of interest
params_lcs_trust_ideal_ppd <- broom::tidy(fit_mi_lcs_trust_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("trust_t2 ~ trust_t1", "d_trust_1 =~ trust_t2", "d_trust_1 ~ trust_t1", # change parameters
...
# parameters of interest
params_lcs_organ_ideal_ppd <- broom::tidy(fit_mi_lcs_organ_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("organ_t2 ~ organ_t1", "d_organ_1 =~ organ_t2", "d_organ_1 ~ organ_t1", # change parameters
...
# parameters of interest
params_lcs_produ_ideal_ppd <- broom::tidy(fit_mi_lcs_produ_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("produ_t2 ~ produ_t1", "d_produ_1 =~ produ_t2", "d_produ_1 ~ produ_t1", # change parameters
...
# parameters of interest
params_lcs_respo_ideal_ppd <- broom::tidy(fit_mi_lcs_respo_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("respo_t2 ~ respo_t1", "d_respo_1 =~ respo_t2", "d_respo_1 ~ respo_t1", # change parameters
...
# parameters of interest
params_lcs_anxie_ideal_ppd <- broom::tidy(fit_mi_lcs_anxie_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("anxie_t2 ~ anxie_t1", "d_anxie_1 =~ anxie_t2", "d_anxie_1 ~ anxie_t1", # change parameters
...
# parameters of interest
params_lcs_depre_ideal_ppd <- broom::tidy(fit_mi_lcs_depre_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("depre_t2 ~ depre_t1", "d_depre_1 =~ depre_t2", "d_depre_1 ~ depre_t1", # change parameters
...
# parameters of interest
params_lcs_volat_ideal_ppd <- broom::tidy(fit_mi_lcs_volat_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("volat_t2 ~ volat_t1", "d_volat_1 =~ volat_t2", "d_volat_1 ~ volat_t1", # change parameters
...
# parameters of interest
params_lcs_curio_ideal_ppd <- broom::tidy(fit_mi_lcs_curio_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("curio_t2 ~ curio_t1", "d_curio_1 =~ curio_t2", "d_curio_1 ~ curio_t1", # change parameters
...
# parameters of interest
params_lcs_aesth_ideal_ppd <- broom::tidy(fit_mi_lcs_aesth_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("aesth_t2 ~ aesth_t1", "d_aesth_1 =~ aesth_t2", "d_aesth_1 ~ aesth_t1", # change parameters
...
# parameters of interest
params_lcs_imagi_ideal_ppd <- broom::tidy(fit_mi_lcs_imagi_ideal_ppd, conf.int = FALSE, conf.level = 0.95) %>% 
  select(term, estimate, std.all, statistic, p.value) %>% 
  filter(term %in% c("imagi_t2 ~ imagi_t1", "d_imagi_1 =~ imagi_t2", "d_imagi_1 ~ imagi_t1", # change parameters
