...
### Measurement invariance: Well-being indicators
...
### Hypothesis 4: Change goals and change in personality (current / ideal) in skill-building group {#hyp4}
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with extraversion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_curr_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with extraversion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_ideal_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with extraversion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_curr_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with extraversion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with agreeableness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_curr_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with agreeableness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_ideal_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_hyp4 %>% filter(term=="d_agree_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with agreeableness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_curr_specif_hyp4 %>% filter(term=="goals ~~ d_agree_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_specif_hyp4 %>% filter(term=="goals ~~ d_agree_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with agreeableness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_agree_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_agree_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with conscientiousness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_curr_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with conscientiousness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_ideal_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_hyp4 %>% filter(term=="d_consc_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with conscientiousness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_curr_specif_hyp4 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_specif_hyp4 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with conscientiousness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with neuroticism change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_neuro_curr_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with neuroticism change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_neuro_ideal_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_hyp4 %>% filter(term=="d_neuro_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with neuroticism change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_neuro_curr_specif_hyp4 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_specif_hyp4 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with neuroticism change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_neuro_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with openness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_openn_curr_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with openness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_openn_ideal_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_hyp4 %>% filter(term=="d_openn_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with openness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_openn_curr_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with openness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_openn_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_specif_hyp4 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with sociability change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_curr_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with sociability change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_ideal_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_hyp4 %>% filter(term=="d_socia_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with sociability change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_curr_specif_hyp4 %>% filter(term=="d_socia_1 ~~ sb07_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_specif_hyp4 %>% filter(term=="d_socia_1 ~~ sb07_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with anxiety change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_ideal_specif_hyp4 %>% filter(term=="d_socia_1 ~~ sb07_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_specif_hyp4 %>% filter(term=="d_socia_1 ~~ sb07_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with assertiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_curr_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with assertiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_ideal_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with assertiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_curr_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with assertiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_ideal_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_specif_hyp4 %>% filter(term=="d_asser_1 ~~ sb07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with energy change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_curr_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with energy change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_ideal_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_hyp4 %>% filter(term=="d_energ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with energy change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_curr_specif_hyp4 %>% filter(term=="d_energ_1 ~~ sb07_03_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_specif_hyp4 %>% filter(term=="d_energ_1 ~~ sb07_03_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with energy change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_ideal_specif_hyp4 %>% filter(term=="d_energ_1 ~~ sb07_03_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_specif_hyp4 %>% filter(term=="d_energ_1 ~~ sb07_03_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with compassion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_curr_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with compassion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_ideal_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_hyp4 %>% filter(term=="d_compa_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with compassion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_curr_specif_hyp4 %>% filter(term=="d_compa_1 ~~ sb07_04_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_specif_hyp4 %>% filter(term=="d_compa_1 ~~ sb07_04_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with compassion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_ideal_specif_hyp4 %>% filter(term=="d_compa_1 ~~ sb07_04_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_specif_hyp4 %>% filter(term=="d_compa_1 ~~ sb07_04_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with respectfulness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_curr_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with respectfulness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_ideal_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_hyp4 %>% filter(term=="d_respe_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with respectfulness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_curr_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the respectfulness change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_respe_ideal_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with trust change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_curr_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with trust change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_ideal_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_hyp4 %>% filter(term=="d_trust_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with trust change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_curr_specif_hyp4 %>% filter(term=="d_trust_1 ~~ sb07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_specif_hyp4 %>% filter(term=="d_trust_1 ~~ sb07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with trust change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_ideal_specif_hyp4 %>% filter(term=="d_trust_1 ~~ sb07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_specif_hyp4 %>% filter(term=="d_trust_1 ~~ sb07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with organization change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_curr_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with organization change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_ideal_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_hyp4 %>% filter(term=="d_organ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with organization change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_curr_specif_hyp4 %>% filter(term=="d_organ_1 ~~ sb07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_specif_hyp4 %>% filter(term=="d_organ_1 ~~ sb07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with organization change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_ideal_specif_hyp4 %>% filter(term=="d_organ_1 ~~ sb07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_specif_hyp4 %>% filter(term=="d_organ_1 ~~ sb07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with productiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_curr_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with productiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_ideal_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_hyp4 %>% filter(term=="d_produ_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with productiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_curr_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with productiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_ideal_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_specif_hyp4 %>% filter(term=="d_produ_1 ~~ sb07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with responsibility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_curr_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with responsibility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_ideal_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_hyp4 %>% filter(term=="d_respo_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with responsibility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_curr_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with responsibility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_ideal_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_specif_hyp4 %>% filter(term=="d_respo_1 ~~ sb07_09_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with anxiety change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_curr_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with anxiety change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_ideal_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_hyp4 %>% filter(term=="d_anxie_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the anxiety change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_anxie_curr_specif_hyp4 %>% filter(term=="d_anxie_1 ~~ sb07_10_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_specif_hyp4 %>% filter(term=="d_anxie_1 ~~ sb07_10_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with anxiety change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_ideal_specif_hyp4 %>% filter(term=="d_anxie_1 ~~ sb07_10_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_specif_hyp4 %>% filter(term=="d_anxie_1 ~~ sb07_10_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with depression change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_curr_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with depression change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_ideal_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_hyp4 %>% filter(term=="d_depre_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with depression change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_curr_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the depression change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_depre_ideal_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_specif_hyp4 %>% filter(term=="d_depre_1 ~~ sb07_11_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with volatility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_curr_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with volatility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_ideal_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_ideal_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with volatility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_curr_specif_hyp4 %>% filter(term=="d_volat_1 ~~ sb07_12_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_specif_hyp4 %>% filter(term=="d_volat_1 ~~ sb07_12_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with volatility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_ideal_specif_hyp4 %>% filter(term=="d_volat_1 ~~ sb07_12_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_ideal_specif_hyp4 %>% filter(term=="d_volat_1 ~~ sb07_12_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with curiosity change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_curr_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with curiosity change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_ideal_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_ideal_hyp4 %>% filter(term=="d_curio_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with curiosity change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_curr_specif_hyp4 %>% filter(term=="d_curio_1 ~~ sb07_13_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_specif_hyp4 %>% filter(term=="d_curio_1 ~~ sb07_13_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with curiosity change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_ideal_specif_hyp4 %>% filter(term=="d_curio_1 ~~ sb07_13_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_ideal_specif_hyp4 %>% filter(term=="d_curio_1 ~~ sb07_13_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with aesthetic change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_curr_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with aesthetic change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_ideal_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_ideal_hyp4 %>% filter(term=="d_aesth_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with aesthetic change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_curr_specif_hyp4 %>% filter(term=="d_aesth_1 ~~ sb07_14_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_specif_hyp4 %>% filter(term=="d_aesth_1 ~~ sb07_14_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with aesthetic change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_ideal_specif_hyp4 %>% filter(term=="d_aesth_1 ~~ sb07_14_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_ideal_specif_hyp4 %>% filter(term=="d_aesth_1 ~~ sb07_14_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with imagination change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_curr_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with imagination change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_ideal_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_hyp4 %>% filter(term=="d_imagi_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with imagination change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_curr_specif_hyp4 %>% filter(term=="d_imagi_1 ~~ sb07_15_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_specif_hyp4 %>% filter(term=="d_imagi_1 ~~ sb07_15_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level change goals with imagination change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_ideal_specif_hyp4 %>% filter(term=="d_imagi_1 ~~ sb07_15_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_specif_hyp4 %>% filter(term=="d_imagi_1 ~~ sb07_15_t1") %>% pull(p.value), 3)`. 
:::
...
### Hypothesis 5: Acceptance goals and change in personality (current / ideal) in self-acceptance group {#hyp5}
...
::: {.callout-note appearance="minimal"}
The correlation of general acceptance goal with the extraversion change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_extra_curr_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with extraversion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_ideal_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_hyp5 %>% filter(term=="d_extra_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with extraversion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_curr_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with extraversion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_extra_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with agreeableness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_curr_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with agreeableness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_ideal_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_hyp5 %>% filter(term=="d_agree_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with agreeableness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_curr_specif_hyp5 %>% filter(term=="goals ~~ d_agree_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_specif_hyp5 %>% filter(term=="goals ~~ d_agree_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with agreeableness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_agree_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_agree_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_agree_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with conscientiousness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_curr_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with conscientiousness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_ideal_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_hyp5 %>% filter(term=="d_consc_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with conscientiousness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_consc_curr_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the conscientiousness change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_consc_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with neuroticism change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_neuro_curr_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with neuroticism change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_neuro_ideal_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with neuroticism change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_neuro_curr_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the neuroticism change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_neuro_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with openness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_openn_curr_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of the general acceptance goal with the openness change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_openn_ideal_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. (I had to use the 'WLSMV' estimator with the "ordered" argument here to get the model to converge - not sure if this is comparable to the other models since a really small estimate becomes significant here...)
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with openness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_openn_curr_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the openness change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_openn_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`. (I had to use the 'WLSMV' estimator with the "ordered" argument here to get the model to converge - not sure if this is comparable to the other models since a really small estimate becomes significant here...)
:::
...
::: {.callout-note appearance="minimal"}
The correlation of the general acceptance goal with the sociability change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_socia_curr_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with sociability change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_ideal_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_hyp5 %>% filter(term=="d_socia_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with sociability change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_curr_specif_hyp5 %>% filter(term=="d_socia_1 ~~ sa07_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_specif_hyp5 %>% filter(term=="d_socia_1 ~~ sa07_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with anxiety change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_socia_ideal_specif_hyp5 %>% filter(term=="d_socia_1 ~~ sa07_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_ideal_specif_hyp5 %>% filter(term=="d_socia_1 ~~ sa07_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with assertiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_curr_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with assertiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_ideal_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with assertiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_curr_specif_hyp5 %>% filter(term=="d_asser_1 ~~ sa07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_specif_hyp5 %>% filter(term=="d_asser_1 ~~ sa07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with assertiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_asser_ideal_specif_hyp5 %>% filter(term=="d_asser_1 ~~ sa07_02_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_specif_hyp5 %>% filter(term=="d_asser_1 ~~ sa07_02_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with energy change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_curr_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with energy change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_ideal_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_hyp5 %>% filter(term=="d_energ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with energy change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_curr_specif_hyp5 %>% filter(term=="d_energ_1 ~~ sa07_03_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_specif_hyp5 %>% filter(term=="d_energ_1 ~~ sa07_03_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with energy change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_energ_ideal_specif_hyp5 %>% filter(term=="d_energ_1 ~~ sa07_03_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_ideal_specif_hyp5 %>% filter(term=="d_energ_1 ~~ sa07_03_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with compassion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_curr_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with compassion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_ideal_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_hyp5 %>% filter(term=="d_compa_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with compassion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_curr_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with compassion change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_compa_ideal_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_ideal_specif_hyp5 %>% filter(term=="d_compa_1 ~~ sa07_04_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with respectfulness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_curr_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with respectfulness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_ideal_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_hyp5 %>% filter(term=="d_respe_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with respectfulness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_curr_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with respectfulness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respe_ideal_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_specif_hyp5 %>% filter(term=="d_respe_1 ~~ sa07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with trust change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_curr_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with trust change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_ideal_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_hyp5 %>% filter(term=="d_trust_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with trust change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_curr_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with trust change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_trust_ideal_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_ideal_specif_hyp5 %>% filter(term=="d_trust_1 ~~ sa07_06_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with organization change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_curr_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with organization change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_ideal_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_hyp5 %>% filter(term=="d_organ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the organization change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_organ_curr_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with organization change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_organ_ideal_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_ideal_specif_hyp5 %>% filter(term=="d_organ_1 ~~ sa07_07_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with productiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_curr_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with productiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_ideal_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_hyp5 %>% filter(term=="d_produ_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with productiveness change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_curr_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with productiveness change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_produ_ideal_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_specif_hyp5 %>% filter(term=="d_produ_1 ~~ sa07_08_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with responsibility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_curr_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with responsibility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_ideal_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_hyp5 %>% filter(term=="d_respo_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the responsibility change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_respo_curr_specif_hyp5 %>% filter(term=="d_respo_1 ~~ sa07_09_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_specif_hyp5 %>% filter(term=="d_respo_1 ~~ sa07_09_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with responsibility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_respo_ideal_specif_hyp5 %>% filter(term=="d_respo_1 ~~ sa07_09_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_ideal_specif_hyp5 %>% filter(term=="d_respo_1 ~~ sa07_09_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with anxiety change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_curr_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with anxiety change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_ideal_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_hyp5 %>% filter(term=="d_anxie_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with anxiety change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_curr_specif_hyp5 %>% filter(term=="d_anxie_1 ~~ sa07_10_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_specif_hyp5 %>% filter(term=="d_anxie_1 ~~ sa07_10_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with anxiety change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_anxie_ideal_specif_hyp5 %>% filter(term=="d_anxie_1 ~~ sa07_10_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_ideal_specif_hyp5 %>% filter(term=="d_anxie_1 ~~ sa07_10_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with depression change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_curr_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with depression change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_ideal_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_hyp5 %>% filter(term=="d_depre_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with depression change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_curr_specif_hyp5 %>% filter(term=="d_depre_1 ~~ sa07_11_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_specif_hyp5 %>% filter(term=="d_depre_1 ~~ sa07_11_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with depression change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_depre_ideal_specif_hyp5 %>% filter(term=="d_depre_1 ~~ sa07_11_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_ideal_specif_hyp5 %>% filter(term=="d_depre_1 ~~ sa07_11_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with volatility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_curr_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of general acceptance goal with the volatility change score (ideal-self) is significantly different from 0, *r* = `r round(params_lcs_volat_ideal_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_ideal_hyp5 %>% filter(term=="d_volat_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with volatility change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_curr_specif_hyp5 %>% filter(term=="d_volat_1 ~~ sa07_12_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_specif_hyp5 %>% filter(term=="d_volat_1 ~~ sa07_12_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with volatility change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_volat_ideal_specif_hyp5 %>% filter(term=="d_volat_1 ~~ sa07_12_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_ideal_specif_hyp5 %>% filter(term=="d_volat_1 ~~ sa07_12_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with curiosity change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_curr_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with curiosity change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_ideal_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_ideal_hyp5 %>% filter(term=="d_curio_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the curiosity change score (current-self) is significantly different from 0, *r* = `r round(params_lcs_curio_curr_specif_hyp5 %>% filter(term=="d_curio_1 ~~ sa07_13_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_specif_hyp5 %>% filter(term=="d_curio_1 ~~ sa07_13_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with curiosity change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_curio_ideal_specif_hyp5 %>% filter(term=="d_curio_1 ~~ sa07_13_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_ideal_specif_hyp5 %>% filter(term=="d_curio_1 ~~ sa07_13_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with aesthetic change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_curr_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with aesthetic change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_ideal_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_ideal_hyp5 %>% filter(term=="d_aesth_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with aesthetic change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_curr_specif_hyp5 %>% filter(term=="d_aesth_1 ~~ sa07_14_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_specif_hyp5 %>% filter(term=="d_aesth_1 ~~ sa07_14_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with aesthetic change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_aesth_ideal_specif_hyp5 %>% filter(term=="d_aesth_1 ~~ sa07_14_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_ideal_specif_hyp5 %>% filter(term=="d_aesth_1 ~~ sa07_14_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with imagination change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_curr_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with imagination change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_ideal_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_hyp5 %>% filter(term=="d_imagi_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with imagination change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_curr_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with imagination change score (ideal-self) is not significantly different from 0, *r* = `r round(params_lcs_imagi_ideal_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_specif_hyp5 %>% filter(term=="d_imagi_1 ~~ sa07_15_t1") %>% pull(p.value), 3)`. 
:::
...
### Hypothesis 6: Desire to change and frequency of skill-building behaviors as moderators of change in personality in skill-building group {#hyp6}
...
df_sbsa_wide_pers_sb_mod <- df_sbsa %>% 
  ...
  select(-c(sb07_01_t2, sb07_02_t2, sb07_03_t2, sb07_04_t2, sb07_05_t2, 
            ...
            sb04_01_t2, sb04_02_t2, sb04_03_t2))
colnames(df_sbsa_wide_pers_sb_mod)
```

#### Big Five traits

##### Extraversion: specific, facet-level change goals
...
d_extra_1 ~~ d_extra_1     # This estimates the variance of the change scores 
extra_t1 ~~ extra_t1       # This estimates the variance of the extra_t1 
d_extra_1 ~ extra_t1 + goals       # This estimates the self-feedback parameter (& moderation effect of goals?)
...
sb07_03_t1 ~ 1
'
fit_mi_lcs_extra_curr_specif_hyp6 <- lavaan(mi_lcs_extra_curr_specif_hyp6, data=df_sbsa_wide_pers_sb_mod, estimator='mlr', fixed.x=FALSE, missing='fiml')
summary(fit_mi_lcs_extra_curr_specif_hyp6, fit.measures=TRUE, standardized=TRUE, rsquare=F)
```
...
params_lcs_extra_curr_specif_hyp6 <- broom::tidy(fit_mi_lcs_extra_curr_specif_hyp6, conf.int = FALSE, conf.level = 0.95) %>% 
        select(term, estimate, std.all, statistic, p.value) %>% 
        filter(term %in% c("extra_t2 ~ extra_t1", "d_extra_1 =~ extra_t2", "d_extra_1 ~ extra_t1", # change parameters
                           "d_extra_1 ~ goals", "goals ~~ goals", # change goals
                           "d_extra_1 ~1 ", "extra_t1 ~1 ", "", # means
                           "d_extra_1 ~~ d_extra_1"))
...
::: {.callout-note appearance="minimal"}
The moderation effect of specific, facet-level change goals with the extraversion change score (current-self) is not significantly different from 0, *r* = `r round(params_lcs_extra_curr_specif_hyp6 %>% filter(term=="d_extra_1 ~ goals") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_specif_hyp6 %>% filter(term=="d_extra_1 ~ goals") %>% pull(p.value), 3)`. 
:::
