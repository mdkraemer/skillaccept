---
title: "Results Study 2: Self-Improvement and Self-Acceptance as Mechanisms of Positive Personality Change"
author: "[blinded]"
toc: true
toc-depth: 5
toc-title: Contents
...
'
fit_configural_extra_curr <- cfa(configural_extra_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
extra_curr1 ~~ extra_curr2
'
fit_weak_extra_curr <- cfa(weak_extra_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
extra_curr1 ~~ extra_curr2
'
fit_strong_extra_curr <- cfa(strong_extra_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
extra_curr1 ~~ extra_curr2
'
fit_strict_extra_curr <- cfa(strict_extra_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_extra_ideal <- cfa(configural_extra_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
extra_ideal1 ~~ extra_ideal2
'
fit_weak_extra_ideal <- cfa(weak_extra_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
extra_ideal1 ~~ extra_ideal2
'
fit_strong_extra_ideal <- cfa(strong_extra_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
extra_ideal1 ~~ extra_ideal2
'
fit_strict_extra_ideal <- cfa(strict_extra_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_agree_curr <- cfa(configural_agree_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
agree_curr1 ~~ agree_curr2
'
fit_weak_agree_curr <- cfa(weak_agree_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
agree_curr1 ~~ agree_curr2
'
fit_strong_agree_curr <- cfa(strong_agree_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
agree_curr1 ~~ agree_curr2
'
fit_strict_agree_curr <- cfa(strict_agree_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_agree_ideal <- cfa(configural_agree_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
agree_ideal1 ~~ agree_ideal2
'
fit_weak_agree_ideal <- cfa(weak_agree_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
agree_ideal1 ~~ agree_ideal2
'
fit_strong_agree_ideal <- cfa(strong_agree_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
agree_ideal1 ~~ agree_ideal2
'
fit_strict_agree_ideal <- cfa(strict_agree_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_consc_curr <- cfa(configural_consc_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
consc_curr1 ~~ consc_curr2
'
fit_weak_consc_curr <- cfa(weak_consc_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
consc_curr1 ~~ consc_curr2
'
fit_strong_consc_curr <- cfa(strong_consc_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
consc_curr1 ~~ consc_curr2
'
fit_strict_consc_curr <- cfa(strict_consc_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_consc_ideal <- cfa(configural_consc_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
consc_ideal1 ~~ consc_ideal2
'
fit_weak_consc_ideal <- cfa(weak_consc_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
consc_ideal1 ~~ consc_ideal2
'
fit_strong_consc_ideal <- cfa(strong_consc_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
consc_ideal1 ~~ consc_ideal2
'
fit_strict_consc_ideal <- cfa(strict_consc_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_neuro_curr <- cfa(configural_neuro_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
neuro_curr1 ~~ neuro_curr2
'
fit_weak_neuro_curr <- cfa(weak_neuro_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
neuro_curr1 ~~ neuro_curr2
'
fit_strong_neuro_curr <- cfa(strong_neuro_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
neuro_curr1 ~~ neuro_curr2
'
fit_strict_neuro_curr <- cfa(strict_neuro_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_neuro_ideal <- cfa(configural_neuro_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
neuro_ideal1 ~~ neuro_ideal2
'
fit_weak_neuro_ideal <- cfa(weak_neuro_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
neuro_ideal1 ~~ neuro_ideal2
'
fit_strong_neuro_ideal <- cfa(strong_neuro_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
neuro_ideal1 ~~ neuro_ideal2
'
fit_strict_neuro_ideal <- cfa(strict_neuro_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_openn_curr <- cfa(configural_openn_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
openn_curr1 ~~ openn_curr2
'
fit_weak_openn_curr <- cfa(weak_openn_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
openn_curr1 ~~ openn_curr2
'
fit_strong_openn_curr <- cfa(strong_openn_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
openn_curr1 ~~ openn_curr2
'
fit_strict_openn_curr <- cfa(strict_openn_curr, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_configural_openn_ideal <- cfa(configural_openn_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
openn_ideal1 ~~ openn_ideal2
'
fit_weak_openn_ideal <- cfa(weak_openn_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
openn_ideal1 ~~ openn_ideal2
'
fit_strong_openn_ideal <- cfa(strong_openn_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
openn_ideal1 ~~ openn_ideal2
'
fit_strict_openn_ideal <- cfa(strict_openn_ideal, data = df_sbsa2_wide_pers, mimic = "mplus", missing="ML")
...
'
fit_mi_lcs_swls_hyp2 <- lavaan(mi_lcs_swls_hyp2, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml')
...
'
fit_mi_lcs_meaning_hyp2 <- lavaan(mi_lcs_meaning_hyp2, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml')
...
'
fit_mi_lcs_selfes_hyp2 <- lavaan(mi_lcs_selfes_hyp2, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml')
...
'
fit_mi_lcs_concept_hyp2 <- lavaan(mi_lcs_concept_hyp2, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml')
...
shapiro.test(df_sbsa2_wide_profdiff$profile_corr_item_z_t2 - df_sbsa2_wide_profdiff$profile_corr_item_z_t1) 
lillie.test(df_sbsa2_wide_profdiff$profile_corr_item_z_t2 - df_sbsa2_wide_profdiff$profile_corr_item_z_t1)

# descriptives
psych::describe(df_sbsa2_wide_profdiff$profile_corr_item_z_t1)
psych::describe(df_sbsa2_wide_profdiff$profile_corr_item_z_t2)

# facet-level profile correlation
shapiro.test(df_sbsa2_wide_profdiff$profile_corr_facet_z_t2 - df_sbsa2_wide_profdiff$profile_corr_facet_z_t1) 
lillie.test(df_sbsa2_wide_profdiff$profile_corr_facet_z_t2 - df_sbsa2_wide_profdiff$profile_corr_facet_z_t1)

# descriptives
psych::describe(df_sbsa2_wide_profdiff$profile_corr_facet_z_t1)
psych::describe(df_sbsa2_wide_profdiff$profile_corr_facet_z_t2)
```
...
#| echo: true
#| warning: false
t_profile_corr_item <- t.test(df_sbsa2_wide_profdiff$profile_corr_item_z_t2, df_sbsa2_wide_profdiff$profile_corr_item_z_t1, paired = TRUE)
t_profile_corr_facet <- t.test(df_sbsa2_wide_profdiff$profile_corr_facet_z_t2, df_sbsa2_wide_profdiff$profile_corr_facet_z_t1, paired = TRUE)
...
#| fig-width: 9.5
#| fig-height: 6.5
profile_df_plot <- df_sbsa2 %>% select(pid, time, profile_corr_item_z, profile_corr_facet_z) %>% 
...
# extra
shapiro.test(df_sbsa2_wide_profdiff$extra_sqdiff_t2 - df_sbsa2_wide_profdiff$extra_sqdiff_t1) 
lillie.test(df_sbsa2_wide_profdiff$extra_sqdiff_t2 - df_sbsa2_wide_profdiff$extra_sqdiff_t1)
# descriptives
psych::describe(df_sbsa2_wide_profdiff$extra_sqdiff_t1)
psych::describe(df_sbsa2_wide_profdiff$extra_sqdiff_t2)

# agree
shapiro.test(df_sbsa2_wide_profdiff$agree_sqdiff_t2 - df_sbsa2_wide_profdiff$agree_sqdiff_t1) 
lillie.test(df_sbsa2_wide_profdiff$agree_sqdiff_t2 - df_sbsa2_wide_profdiff$agree_sqdiff_t1)
# descriptives
psych::describe(df_sbsa2_wide_profdiff$agree_sqdiff_t1)
psych::describe(df_sbsa2_wide_profdiff$agree_sqdiff_t2)

# consc
shapiro.test(df_sbsa2_wide_profdiff$consc_sqdiff_t2 - df_sbsa2_wide_profdiff$consc_sqdiff_t1) 
lillie.test(df_sbsa2_wide_profdiff$consc_sqdiff_t2 - df_sbsa2_wide_profdiff$consc_sqdiff_t1)
# descriptives
psych::describe(df_sbsa2_wide_profdiff$consc_sqdiff_t1)
psych::describe(df_sbsa2_wide_profdiff$consc_sqdiff_t2)

# neuro
shapiro.test(df_sbsa2_wide_profdiff$neuro_sqdiff_t2 - df_sbsa2_wide_profdiff$neuro_sqdiff_t1) 
lillie.test(df_sbsa2_wide_profdiff$neuro_sqdiff_t2 - df_sbsa2_wide_profdiff$neuro_sqdiff_t1)
# descriptives
psych::describe(df_sbsa2_wide_profdiff$neuro_sqdiff_t1)
psych::describe(df_sbsa2_wide_profdiff$neuro_sqdiff_t2)

# openn
shapiro.test(df_sbsa2_wide_profdiff$openn_sqdiff_t2 - df_sbsa2_wide_profdiff$openn_sqdiff_t1) 
lillie.test(df_sbsa2_wide_profdiff$openn_sqdiff_t2 - df_sbsa2_wide_profdiff$openn_sqdiff_t1)
# descriptives
psych::describe(df_sbsa2_wide_profdiff$openn_sqdiff_t1)
psych::describe(df_sbsa2_wide_profdiff$openn_sqdiff_t2)
```
...
d_trait <- cohend_cust(paste0(str_trunc(names(b5_vars)[1], 5, ellipsis = ""), "_sqdiff"), df_sbsa2)
d_traits_unlist <- as_tibble(d_trait$cohen.d)
for (i in 2:length(names(b5_vars))) {
  d_trait <- cohend_cust(paste0(str_trunc(names(b5_vars)[i], 5, ellipsis = ""), "_sqdiff"), df_sbsa2)
...
df_sbsa2_wide_pers_sb <- df_sbsa2_wide_pers %>% left_join(group_assign) %>% filter(rando=="Self-Improvement") %>% select(-rando) %>%
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with extraversion change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_extra_ideal_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_extra_ideal_hyp4 %>% filter(term=="d_extra_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with assertiveness change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_asser_ideal_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_asser_ideal_hyp4 %>% filter(term=="d_asser_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level change goals with the respectfulness change score (ideal-self) is (barely) significantly different from zero, *r* = `r round(params_lcs_respe_ideal_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_respe_ideal_specif_hyp4 %>% filter(term=="d_respe_1 ~~ sb07_05_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general change goal with volatility change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_volat_ideal_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_volat_ideal_hyp4 %>% filter(term=="d_volat_1 ~~ sb06_01_t1") %>% pull(p.value), 3)`. 
:::
...
d_aesth_1 ~ aesth_t1       # This estimates the self-feedback parameter
...
fit_mi_lcs_aesth_curr_hyp4 <- lavaan(mi_lcs_aesth_curr_hyp4, 
                                     data=df_sbsa2_wide_pers_sb %>% filter(!is.na(bf05_05_t1) & !is.na(bf05_05_t2)), 
...
df_sbsa2_wide_pers_sa <- df_sbsa2_wide_pers %>% left_join(group_assign) %>% filter(rando=="Self-Acceptance") %>% select(-rando) %>%
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the conscientiousness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_consc_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_consc_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_consc_1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with neuroticism change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_neuro_curr_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_neuro_curr_hyp5 %>% filter(term=="d_neuro_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Correlation of specific, facet-level acceptance goals with neuroticism change score (current-self) is not significantly different from zero, *r* = `r round(params_lcs_neuro_curr_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_neuro_curr_specif_hyp5 %>% filter(term=="goals ~~ d_neuro_1") %>% pull(p.value), 3)`. 
:::
...
Correlation of general acceptance goal with openness change score (ideal-self) is significantly different from zero, *r* = `r round(params_lcs_openn_ideal_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_openn_ideal_hyp5 %>% filter(term=="d_openn_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`.
:::
...
::: {.callout-note appearance="minimal"}
The correlation of specific, facet-level acceptance goals with the openness change score (ideal-self) is not significantly different from zero, *r* = `r round(params_lcs_openn_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_openn_ideal_specif_hyp5 %>% filter(term=="goals ~~ d_openn_1") %>% pull(p.value), 3)`.  
:::
...
::: {.callout-note appearance="minimal"}
Correlation of general acceptance goal with assertiveness change score (current-self) is significantly different from zero, *r* = `r round(params_lcs_asser_curr_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_asser_curr_hyp5 %>% filter(term=="d_asser_1 ~~ sa06_01_t1") %>% pull(p.value), 3)`. 
:::
...
### H6: Desire to change and frequency of self-improvement behaviors as moderators of change in personality in self-improvement group {#hyp6}
...
df_sbsa2_wide_pers_sb_mod <- df_sbsa2_wide_pers %>% left_join(group_assign) %>% filter(rando=="Self-Improvement") %>% select(-rando) %>%
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the extraversion change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_extra_curr_frequ_hyp6 %>% filter(term=="d_extra_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_extra_curr_frequ_hyp6 %>% filter(term=="d_extra_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-improvement behaviors significantly moderates changes in agreeableness (current-self), *b* = `r round(params_lcs_agree_curr_frequ_hyp6 %>% filter(term=="d_agree_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_agree_curr_frequ_hyp6 %>% filter(term=="d_agree_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-improvement behaviors significantly moderates changes in conscientiousness (current-self), *b* = `r round(params_lcs_consc_curr_frequ_hyp6 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_curr_frequ_hyp6 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the neuroticism change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_neuro_curr_frequ_hyp6 %>% filter(term=="d_neuro_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_neuro_curr_frequ_hyp6 %>% filter(term=="d_neuro_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-improvement behaviors significantly moderates changes in openness (current-self), *b* = `r round(params_lcs_openn_curr_frequ_hyp6 %>% filter(term=="d_openn_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_openn_curr_frequ_hyp6 %>% filter(term=="d_openn_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with sociability change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_socia_curr_frequ_hyp6 %>% filter(term=="d_socia_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_socia_curr_frequ_hyp6 %>% filter(term=="d_socia_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the assertiveness change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_asser_curr_frequ_hyp6 %>% filter(term=="d_asser_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_frequ_hyp6 %>% filter(term=="d_asser_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the energy change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_energ_curr_frequ_hyp6 %>% filter(term=="d_energ_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_energ_curr_frequ_hyp6 %>% filter(term=="d_energ_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-improvement behaviors significantly moderates changes in compassion (current-self), *b* = `r round(params_lcs_compa_curr_frequ_hyp6 %>% filter(term=="d_compa_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_compa_curr_frequ_hyp6 %>% filter(term=="d_compa_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the respectfulness change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_respe_curr_frequ_hyp6 %>% filter(term=="d_respe_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_curr_frequ_hyp6 %>% filter(term=="d_respe_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
The moderation effect of the self-improvement behaviors with the trust change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_trust_curr_frequ_hyp6 %>% filter(term=="d_trust_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_trust_curr_frequ_hyp6 %>% filter(term=="d_trust_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the organization change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_organ_curr_frequ_hyp6 %>% filter(term=="d_organ_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_organ_curr_frequ_hyp6 %>% filter(term=="d_organ_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-improvement behaviors significantly moderates changes in productiveness (current-self), *b* = `r round(params_lcs_produ_curr_frequ_hyp6 %>% filter(term=="d_produ_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_curr_frequ_hyp6 %>% filter(term=="d_produ_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the responsibility change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_respo_curr_frequ_hyp6 %>% filter(term=="d_respo_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_frequ_hyp6 %>% filter(term=="d_respo_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the anxiety change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_anxie_curr_frequ_hyp6 %>% filter(term=="d_anxie_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_anxie_curr_frequ_hyp6 %>% filter(term=="d_anxie_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the depression change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_depre_curr_frequ_hyp6 %>% filter(term=="d_depre_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_depre_curr_frequ_hyp6 %>% filter(term=="d_depre_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the volatility change score (current-self) is significantly different from zero, *b* = `r round(params_lcs_volat_curr_frequ_hyp6 %>% filter(term=="d_volat_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_volat_curr_frequ_hyp6 %>% filter(term=="d_volat_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the curiosity change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_curio_curr_frequ_hyp6 %>% filter(term=="d_curio_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_curio_curr_frequ_hyp6 %>% filter(term=="d_curio_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
d_aesth_1 ~ aesth_t1 + sb07_14_t1   # This estimates the self-feedback parameter and the moderation effect on the change score
...
::: {.callout-note appearance="minimal"}
The facet-specific change goal significantly moderates changes in the aesthetic score (current-self), *b* = `r round(params_lcs_aesth_curr_specif_hyp6 %>% filter(term=="d_aesth_1 ~ sb07_14_t1") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_specif_hyp6 %>% filter(term=="d_aesth_1 ~ sb07_14_t1") %>% pull(p.value), 3)`. 
:::
...
d_aesth_1 ~ aesth_t1 + frequ   # This estimates the self-feedback parameter and the moderation effect on the change score
...
fit_mi_lcs_aesth_curr_frequ_hyp6 <- lavaan(mi_lcs_aesth_curr_frequ_hyp6, 
                                            data=df_sbsa2_wide_pers_sb_mod %>% filter(!is.na(bf05_05_t1) & !is.na(bf05_05_t2)), 
                                            estimator='mlr', fixed.x=FALSE, missing="fiml")
# This model did not converge properly with missing data and FIML -> no problem when only using complete data
...
::: {.callout-note appearance="minimal"}
The frequency of self-improvement behaviors significantly moderates changes in the aesthetic score (current-self), *b* = `r round(params_lcs_aesth_curr_frequ_hyp6 %>% filter(term=="d_aesth_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_aesth_curr_frequ_hyp6 %>% filter(term=="d_aesth_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The moderation effect of the frequency of self-improvement behaviors with the imagination change score (current-self) is not significantly different from zero, *b* = `r round(params_lcs_imagi_curr_frequ_hyp6 %>% filter(term=="d_imagi_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_curr_frequ_hyp6 %>% filter(term=="d_imagi_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
Results summary across the Big Five traits: trait-specific change goals (*goals*) and frequency of self-improvement behaviors (*frequency*) as moderators on the latent change score
```{r}
#| echo: true
#| fig-width: 9.5
#| fig-height: 6.5
...
Results summary across the Big Five facets: trait-specific change goals (*goals*) and frequency of self-improvement behaviors (*frequency*) as moderators on the latent change score
```{r}
#| echo: true
#| fig-width: 9.5
#| fig-height: 6.5
...
df_sbsa2_wide_pers_sa_mod <- df_sbsa2_wide_pers %>% left_join(group_assign) %>% filter(rando=="Self-Acceptance") %>% select(-rando) %>%
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in conscientiousness (ideal-self), *b* = `r round(params_lcs_consc_ideal_frequ_hyp7 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_frequ_hyp7 %>% filter(term=="d_consc_1 ~ frequ") %>% pull(p.value), 3)`.  
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in assertiveness (ideal-self), *b* = `r round(params_lcs_asser_ideal_frequ_hyp7 %>% filter(term=="d_asser_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_ideal_frequ_hyp7 %>% filter(term=="d_asser_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in respectfulness (ideal-self), *b* = `r round(params_lcs_respe_ideal_frequ_hyp7 %>% filter(term=="d_respe_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respe_ideal_frequ_hyp7 %>% filter(term=="d_respe_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
The frequency of self-acceptance behaviors significantly moderates changes in productiveness (ideal-self), *b* = `r round(params_lcs_produ_ideal_frequ_hyp7 %>% filter(term=="d_produ_1 ~ frequ") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_produ_ideal_frequ_hyp7 %>% filter(term=="d_produ_1 ~ frequ") %>% pull(p.value), 3)`. 
:::
...
'
lcs_swls_group_config <- sem(mi_lcs_swls_group_config, data=df_sbsa2_wide_wb, estimator='mlr', 
...
lcs_swls_group_weak <- sem(mi_lcs_swls_group_weak, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
...
lcs_swls_group_strong <- sem(mi_lcs_swls_group_strong, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
...
'
lcs_meaning_group_config <- sem(mi_lcs_meaning_group_config, data=df_sbsa2_wide_wb, estimator='mlr', 
                                fixed.x=FALSE, missing='fiml', group = "rando")
...
lcs_meaning_group_weak <- sem(mi_lcs_meaning_group_weak, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                           group = "rando", group.equal = "loadings")
...
lcs_meaning_group_strong <- sem(mi_lcs_meaning_group_strong, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                             group = "rando", group.equal = c("intercepts", "loadings"))
```
...
'
lcs_selfes_group_config <- sem(mi_lcs_selfes_group_config, data=df_sbsa2_wide_wb, estimator='mlr', 
                                fixed.x=FALSE, missing='fiml', group = "rando")
...
lcs_selfes_group_weak <- sem(mi_lcs_selfes_group_weak, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                           group = "rando", group.equal = "loadings")
...
lcs_selfes_group_strong <- sem(mi_lcs_selfes_group_strong, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                             group = "rando", group.equal = c("intercepts", "loadings"))
```
...
'
lcs_concept_group_config <- sem(mi_lcs_concept_group_config, data=df_sbsa2_wide_wb, estimator='mlr', 
                                fixed.x=FALSE, missing='fiml', group = "rando")
...
lcs_concept_group_weak <- sem(mi_lcs_concept_group_weak, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                           group = "rando", group.equal = "loadings")
...
lcs_concept_group_strong <- sem(mi_lcs_concept_group_strong, data=df_sbsa2_wide_wb, estimator='mlr', fixed.x=FALSE, missing='fiml', 
                             group = "rando", group.equal = c("intercepts", "loadings"))
```
...
#| warning: false
#| cache: true
df_sbsa2 <- df_sbsa2 %>% mutate(time_d = time - 1)

psych::describeBy(df_sbsa2$profile_corr_item_z, list(df_sbsa2$rando, df_sbsa2$time_d))
psych::describeBy(df_sbsa2$profile_corr_facet_z, list(df_sbsa2$rando, df_sbsa2$time_d))

lm_profile_corr_item <- lmerTest::lmer(profile_corr_item_z ~ time_d * rando + (1 | pid), data = df_sbsa2)
lm_profile_corr_facet <- lmerTest::lmer(profile_corr_facet_z ~ time_d * rando + (1 | pid), data = df_sbsa2)
...
#| warning: false
#| cache: true
mod_traits_sqdiff_groups <- df_sbsa2 %>% 
...
df_sbsa2_wide_pers_sb_ppd <- df_sbsa2 %>% 
  filter(rando=="Self-Improvement") %>% 
  arrange(pid, time) %>% 
...
# colnames(df_sbsa2_wide_pers_sb_ppd)

group_assign <- df_sbsa2 %>% select(pid, rando) %>% unique()

df_sbsa2_wide_pers_sb_ppd <- df_sbsa2_wide_pers %>% left_join(group_assign) %>% filter(rando=="Self-Improvement") %>% select(-rando) %>%
  left_join(df_sbsa2_wide_pers_sb_ppd)
...
df_sbsa2_wide_pers_sb_ppd <- df_sbsa2_wide_pers_sb_ppd %>% mutate(ppd = rowMeans(across(c(sb01_01_t1, sb01_02_t1)), na.rm=T))
```
...
for (i in 1:5) {
  ...
  template_filled <- str_replace_all(trait_template_ppd_improve, 
                                       c("trait" = short_name,
                                         ...
                                         "ind02" = paste0(short_name, "_curr_par2"), 
                                         "ind03" = paste0(short_name, "_curr_par3")))
  trait_model_fit <- lavaan(template_filled, data=df_sbsa2_wide_pers_sb_ppd, estimator='mlr', fixed.x=FALSE, missing='fiml')
  eval(call("<-", as.name(paste0("mi_lcs_", short_name, "_", 
...
for (i in 6:length(b5_vars)) {
  ...
  template_filled <- str_replace_all(facet_template_ppd_improve, 
                                       c("facet" = short_name,
                                         "ind1" = items[1], "ind2" = items[2], "ind3" = items[3], "ind4" = items[4]))
  facet_model_fit <- lavaan(template_filled, data=df_sbsa2_wide_pers_sb_ppd, estimator='mlr', fixed.x=FALSE, missing='fiml')
  eval(call("<-", as.name(paste0("mi_lcs_", short_name, "_", 
                                     str_sub(names(bfi_versions)[5], 6), "_ppd")), template_filled))
  eval(call("<-", as.name(paste0("fit_mi_lcs_", short_name, "_", 
...
::: {.callout-note appearance="minimal"}
Personal project dimensions significantly moderate changes in assertiveness (current-self), *b* = `r round(params_lcs_asser_curr_ppd %>% filter(term=="d_asser_1 ~ ppd") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_asser_curr_ppd %>% filter(term=="d_asser_1 ~ ppd") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Personal project dimensions significantly moderate changes in responsibility (current-self), *b* = `r round(params_lcs_respo_curr_ppd %>% filter(term=="d_respo_1 ~ ppd") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_respo_curr_ppd %>% filter(term=="d_respo_1 ~ ppd") %>% pull(p.value), 3)`. 
:::
...
d_aesth_1 ~ aesth_t1 + ppd   # This estimates the self-feedback parameter and the moderation effect on the change score
...
fit_mi_lcs_aesth_curr_ppd <- lavaan(mi_lcs_aesth_curr_ppd, 
                                            data=df_sbsa2_wide_pers_sb_ppd %>% filter(!is.na(bf05_05_t1) & !is.na(bf05_05_t2)), 
                                            estimator='mlr', fixed.x=FALSE, missing="fiml")
# This model did not converge properly with missing data and FIML -> no problem when only using complete data
...
df_sbsa2_wide_pers_sa_ppd <- df_sbsa2 %>% 
  filter(rando=="Self-Acceptance") %>% 
  arrange(pid, time) %>% 
...
# colnames(df_sbsa2_wide_pers_sa_ppd)

group_assign <- df_sbsa2 %>% select(pid, rando) %>% unique()

df_sbsa2_wide_pers_sa_ppd <- df_sbsa2_wide_pers %>% left_join(group_assign) %>% filter(rando=="Self-Acceptance") %>% select(-rando) %>%
  left_join(df_sbsa2_wide_pers_sa_ppd)

# need to form a mean score because some models did not converge when using the latent factor of PPD (but high correlation between the two items)
df_sbsa2_wide_pers_sa_ppd <- df_sbsa2_wide_pers_sa_ppd %>% mutate(ppd = rowMeans(across(c(sa01_01_t1, sa01_02_t1)), na.rm=T))
...
for (i in 1:5) {
  ...
  template_filled <- str_replace_all(trait_template_ppd_accept, 
                                       c("trait" = short_name,
                                         ...
                                         "ind02" = paste0(short_name, "_ideal_par2"), 
                                         "ind03" = paste0(short_name, "_ideal_par3")))
  trait_model_fit <- lavaan(template_filled, data=df_sbsa2_wide_pers_sa_ppd, estimator='mlr', fixed.x=FALSE, missing='fiml')
  eval(call("<-", as.name(paste0("mi_lcs_", short_name, "_", 
...
::: {.callout-note appearance="minimal"}
The moderation effect of personal project dimensions with the conscientiousness change score (ideal-self) is not significantly different from zero, *b* = `r round(params_lcs_consc_ideal_ppd %>% filter(term=="d_consc_1 ~ ppd") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_consc_ideal_ppd %>% filter(term=="d_consc_1 ~ ppd") %>% pull(p.value), 3)`. 
:::
...
for (i in 6:length(b5_vars)) {
  ...
  template_filled <- str_replace_all(facet_template_ppd_accept, 
                                       c("facet" = short_name,
                                         "ind1" = items[1], "ind2" = items[2], "ind3" = items[3], "ind4" = items[4]))
  facet_model_fit <- lavaan(template_filled, data=df_sbsa2_wide_pers_sa_ppd, estimator='mlr', fixed.x=FALSE, missing='fiml')
  eval(call("<-", as.name(paste0("mi_lcs_", short_name, "_", 
                                     str_sub(names(bfi_versions)[6], 6), "_ppd")), template_filled))
  eval(call("<-", as.name(paste0("fit_mi_lcs_", short_name, "_", 
...
::: {.callout-note appearance="minimal"}
The moderation effect of personal project dimensions with the imagination change score (ideal-self) is not significantly different from zero, *b* = `r round(params_lcs_imagi_ideal_ppd %>% filter(term=="d_imagi_1 ~ ppd") %>% pull(estimate), 3)`, *p* = `r round(params_lcs_imagi_ideal_ppd %>% filter(term=="d_imagi_1 ~ ppd") %>% pull(p.value), 3)`. 
:::
