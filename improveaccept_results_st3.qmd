...
df_sbsa3_wide_wb <- df_sbsa3_wide_wb %>% 
  ...
  mutate(meaning_par1_t1 = rowMeans(across(c(ml01_06_t1, ml01_10_t1_r, ml01_03_t1_r, ml01_07_t1_r)), na.rm=T),
         meaning_par2_t1 = rowMeans(across(c(ml01_04_t1, ml01_05_t1, ml01_02_t1_r)), na.rm=T),
         meaning_par3_t1 = rowMeans(across(c(ml01_09_t1_r, ml01_01_t1, ml01_08_t1_r)), na.rm=T),
         meaning_par1_t2 = rowMeans(across(c(ml01_06_t2, ml01_10_t2_r, ml01_03_t2_r, ml01_07_t2_r)), na.rm=T),
         meaning_par2_t2 = rowMeans(across(c(ml01_04_t2, ml01_05_t2, ml01_02_t2_r)), na.rm=T),
         meaning_par3_t2 = rowMeans(across(c(ml01_09_t2_r, ml01_01_t2, ml01_08_t2_r)), na.rm=T))
```
...
df_manip_check_wb_forplot <- df_sbsa3 %>% 
  mutate(time_d = time - 1) %>% 
  select(pid, time_d, group, swls, meaning, selfes, concept) %>% 
  pivot_longer(-c(pid, time_d, group), 
               cols_vary = "slowest",
               names_to = c("trait"),
               values_to = "score") %>% 
...
cormat_profile <- cor(df_sbsa3[, c("swls", "meaning", "selfes", "concept",
...
bind_rows(
  ...
  correlation::cor_to_ci(cormat_profile[5, c(1:4)], n = (df_sbsa3 %>% filter(!is.na(swls)) 
                                        %>% tally() %>% pull())) %>% as_tibble(),
  correlation::cor_to_p(cormat_profile[5, c(1:4)], n = (df_sbsa3 %>% filter(!is.na(swls)) 
...
bind_cols(
  cormat_profile[6, c(1:4)] %>% as_tibble() %>% 
    ...
    select(profile_sim, wellbeing, corr = value),
  correlation::cor_to_ci(cormat_profile[6, c(1:4)], n = (df_sbsa3 %>% filter(!is.na(swls)) 
                                        %>% tally() %>% pull())) %>% as_tibble(),
  correlation::cor_to_p(cormat_profile[6, c(1:4)], n = (df_sbsa3 %>% filter(!is.na(swls)) 
                                      %>% tally() %>% pull())) %>% as_tibble() %>% select(p)
  )
) %>% kable(digits = 3)
```
...
# T1
cormat_profile_gr1_t1 <- cor((df_sbsa3 %>% filter(group=="Group 1" & time==1))[, c("swls", "meaning", "selfes", "concept",                                  "profile_corr_item_z", "profile_corr_facet_z")], use = "pairwise.complete.obs")
rownames(cormat_profile_gr1_t1) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                              "Item-Level Profile Corr (z)", "Facet-Level Profile Corr (z)")
colnames(cormat_profile_gr1_t1) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                              "Item-Level Profile Corr (z)", "Facet-Level Profile Corr (z)")

# T2
cormat_profile_gr1_t2 <- cor((df_sbsa3 %>% filter(group=="Group 1" & time==2))[, c("swls", "meaning", "selfes", "concept",                                  "profile_corr_item_z", "profile_corr_facet_z")], use = "pairwise.complete.obs")
rownames(cormat_profile_gr1_t2) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                              "Item-Level Profile Corr (z)", "Facet-Level Profile Corr (z)")
colnames(cormat_profile_gr1_t2) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                              "Item-Level Profile Corr (z)", "Facet-Level Profile Corr (z)")
```
...
cormat_sqtraits <- cor(df_sbsa3[, c("swls", "meaning", "selfes", "concept",
...
cormat_sqfacets <- cor(df_sbsa3[, c("swls", "meaning", "selfes", "concept",
...
# T1
cormat_sqtraits_gr1_t1 <- cor((df_sbsa3 %>% filter(group=="Group 1" & time==1))[, c("swls", "meaning", "selfes", "concept",
                                   paste0(str_trunc(names(b5_vars)[1:5], 5, ellipsis = ""), "_sqdiff"))], 
                       use = "pairwise.complete.obs")
rownames(cormat_sqtraits_gr1_t1) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                               str_to_title(names(b5_vars)[1:5]))
colnames(cormat_sqtraits_gr1_t1) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                               str_to_title(names(b5_vars)[1:5]))

# T2
cormat_sqtraits_gr1_t2 <- cor((df_sbsa3 %>% filter(group=="Group 1" & time==2))[, c("swls", "meaning", "selfes", "concept",
                                   paste0(str_trunc(names(b5_vars)[1:5], 5, ellipsis = ""), "_sqdiff"))], 
                       use = "pairwise.complete.obs")
rownames(cormat_sqtraits_gr1_t2) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                               str_to_title(names(b5_vars)[1:5]))
colnames(cormat_sqtraits_gr1_t2) <- c("Life Satisfaction", "Meaning in Life", "Self-Esteem" , "Self Concept Clarity", 
                               str_to_title(names(b5_vars)[1:5]))
```
...
::: {.callout-note appearance="minimal"}
Significantly higher life satisfaction at the post test, *b* = `r round(params_lcs_swls_hyp2 %>% filter(term=="d_swls_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_swls_hyp2 %>% filter(term=="d_swls_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_swls_hyp2 %>% filter(term=="d_swls_1 ~1 ") %>% pull(p.value), 3)`. Those with initially higher levels of life satisfaction (at T1) change to a lesser degree.
:::
...
::: {.callout-note appearance="minimal"}
Participants improved significantly in meaning in life across time, *b* = `r round(params_lcs_meaning_hyp2 %>% filter(term=="d_meaning_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_meaning_hyp2 %>% filter(term=="d_meaning_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_meaning_hyp2 %>% filter(term=="d_meaning_1 ~1 ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Self concept clarity improved significantly across time, *b* = `r round(params_lcs_concept_hyp2 %>% filter(term=="d_concept_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_concept_hyp2 %>% filter(term=="d_concept_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_concept_hyp2 %>% filter(term=="d_concept_1 ~1 ") %>% pull(p.value), 3)`.
:::
...
::: {.callout-note appearance="minimal"}
Significantly higher extraversion at the post test, *b* = `r round(params_lcs_extra_hyp2 %>% filter(term=="d_extra_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_extra_hyp2 %>% filter(term=="d_extra_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_extra_hyp2 %>% filter(term=="d_extra_1 ~1 ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
No significant changes in agreeableness from pre to post test, *b* = `r round(params_lcs_agree_hyp2 %>% filter(term=="d_agree_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_agree_hyp2 %>% filter(term=="d_agree_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_agree_hyp2 %>% filter(term=="d_agree_1 ~1 ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Significantly higher conscientiousness at the post test, *b* = `r round(params_lcs_consc_hyp2 %>% filter(term=="d_consc_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_consc_hyp2 %>% filter(term=="d_consc_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_consc_hyp2 %>% filter(term=="d_consc_1 ~1 ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
Significantly lower neuroticism at the post test, *b* = `r round(params_lcs_neuro_hyp2 %>% filter(term=="d_neuro_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_neuro_hyp2 %>% filter(term=="d_neuro_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_neuro_hyp2 %>% filter(term=="d_neuro_1 ~1 ") %>% pull(p.value), 3)`. 
:::
...
::: {.callout-note appearance="minimal"}
No significant changes in openness from pre to post test, *b* = `r round(params_lcs_openn_hyp2 %>% filter(term=="d_openn_1 ~1 ") %>% pull(estimate), 3)`, *beta* = `r round(params_lcs_openn_hyp2 %>% filter(term=="d_openn_1 ~1 ") %>% pull(std.all), 3)`, *p* = `r round(params_lcs_openn_hyp2 %>% filter(term=="d_openn_1 ~1 ") %>% pull(p.value), 3)`. 
:::
...
params_main_summary_12 <- bind_rows(
  params_main_lcs_extra_group_12 %>% mutate(trait = names(b5_vars)[1], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_agree_group_12 %>% mutate(trait = names(b5_vars)[2], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_consc_group_12 %>% mutate(trait = names(b5_vars)[3], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_neuro_group_12 %>% mutate(trait = names(b5_vars)[4], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_openn_group_12 %>% mutate(trait = names(b5_vars)[5], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff)) %>% mutate(group = ifelse(group=="d_int_a", "Group 1", "Group 2"))
...
params_main_summary_23 <- bind_rows(
  params_main_lcs_extra_group_23 %>% mutate(trait = names(b5_vars)[1], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_agree_group_23 %>% mutate(trait = names(b5_vars)[2], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_consc_group_23 %>% mutate(trait = names(b5_vars)[3], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_neuro_group_23 %>% mutate(trait = names(b5_vars)[4], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff),
  params_main_lcs_openn_group_23 %>% mutate(trait = names(b5_vars)[5], self = "current") %>% select(trait, self, group = label, beta = std.all, p.value, sig_diff)) %>% mutate(group = ifelse(group=="d_int_a", "Group 2", "Group 3"))
...
params_main_summary_wb_12 <- bind_rows(
  params_lcs_swls_group_12_weak %>% mutate(trait = "Life Satisfaction") %>% select(trait, group = label, beta = std.all, p.value, sig_diff),
  params_lcs_meaning_group_12_weak %>% mutate(trait = "Meaning in Life") %>% select(trait, group = label, beta = std.all, p.value, sig_diff),
  params_lcs_selfes_group_12_weak %>% mutate(trait = "Self-Esteem") %>% select(trait, group = label, beta = std.all, p.value, sig_diff),
  params_lcs_concept_group_12_weak %>% mutate(trait = "Self-Concept Clarity") %>% select(trait, group = label, beta = std.all, p.value, sig_diff)) %>% mutate(group = ifelse(group=="d_int_a", "Group 1", "Group 2"))
...
params_main_summary_wb_23 <- bind_rows(
  params_lcs_swls_group_23_weak %>% mutate(trait = "Life Satisfaction") %>% select(trait, group = label, beta = std.all, p.value, sig_diff),
  params_lcs_meaning_group_23_weak %>% mutate(trait = "Meaning in Life") %>% select(trait, group = label, beta = std.all, p.value, sig_diff),
  params_lcs_selfes_group_23_weak %>% mutate(trait = "Self-Esteem") %>% select(trait, group = label, beta = std.all, p.value, sig_diff),
  params_lcs_concept_group_23_weak %>% mutate(trait = "Self-Concept Clarity") %>% select(trait, group = label, beta = std.all, p.value, sig_diff)) %>% mutate(group = ifelse(group=="d_int_a", "Group 2", "Group 3"))
...
b5_latent_df_plot <- bind_rows(
  broom::tidy(fit_lcs_extra_main_weak_group_12, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Extraversion", Group = ifelse(label %in% c("d_int_a", "b5_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(fit_lcs_agree_main_weak_group_12, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Agreeableness", Group = ifelse(label %in% c("d_int_a", "b5_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(fit_lcs_consc_main_weak_group_12, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Conscientiousness", Group = ifelse(label %in% c("d_int_a", "b5_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(fit_lcs_neuro_main_weak_group_12, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Neuroticism", Group = ifelse(label %in% c("d_int_a", "b5_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(fit_lcs_openn_main_weak_group_12, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Openness", Group = ifelse(label %in% c("d_int_a", "b5_int_a"), "Group 1", "Group 2")),
...
wb_latent_df_plot <- bind_rows(
  broom::tidy(lcs_swls_group_12_weak, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Life Satisfaction", Group = ifelse(label %in% c("d_int_a", "wb_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(lcs_meaning_group_12_weak, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Meaning in Life", Group = ifelse(label %in% c("d_int_a", "wb_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(lcs_selfes_group_12_weak, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Self-Esteem", Group = ifelse(label %in% c("d_int_a", "wb_int_a"), "Group 1", "Group 2")),
  ...
  broom::tidy(lcs_concept_group_12_weak, conf.int = T, conf.level = .99) %>% select(term, label, estimate, std.error, conf.low, conf.high) %>% 
    ...
    mutate(Trait = "Self-Concept Clarity", Group = ifelse(label %in% c("d_int_a", "wb_int_a"), "Group 1", "Group 2")),
